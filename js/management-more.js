(() => {
  ...
  function syncActiveState() {
    const anyMoreTargetActive = Array.from(
      app.querySelectorAll(".mgmt-nav-secondary, [data-site-studio-tab='accounts'], [data-site-studio-tab='media'], [data-site-studio-tab='travel'], [data-site-studio-tab='analytics']")
